...
from .manager_term_cfg import ConcatObservationTermCfg, ConcatObservationGroupCfg, ObservationTermCfg

if TYPE_CHECKING:
    from isaaclab.envs import ManagerBasedEnv


class ConcatObservationManager(ManagerBase):
    ...
    def _prepare_terms(self):
        ...
        for group_name, group_cfg in group_cfg_items:
            ...
            if not isinstance(group_cfg, ConcatObservationGroupCfg):
                raise TypeError(
